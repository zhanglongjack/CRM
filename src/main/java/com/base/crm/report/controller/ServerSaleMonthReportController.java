...
import com.base.crm.report.excel.ServerSaleMonthReportExcelMappings;
import com.base.crm.users.entity.UserInfo;

@Controller
@RequestMapping(value = "/serverSaleMonthReport")
@SessionAttributes("user")
public class ServerSaleMonthReportController {
	private final Logger logger = LoggerFactory.getLogger(getClass());
	
	@Autowired
	private ServerSaleMonthReportExcelMappings mapping;
	@Autowired
